            ...
            <table class = "table shinetable" id = "table">
                ...
                <td  class = "col-xs-0 col-md-11 col-lg-11 col-sm-11">
                  <div class = "row">
                    <div class = "container-fluid col-xs-12 col-md-12 col-sm-12 col-lg-12 ">
                      <div id = "healthprog" class="progress-bar progress-bar-danger active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </td>
              </tr>
              <tr class = "row">
                ...
                <td  class = "col-xs-0 col-md-11 col-lg-11 col-sm-11">
                  <div class = "row">
                    <div class = "container-fluid col-xs-12 col-md-12 col-sm-12 col-lg-12 ">
                      <div id = "earthprog" class="progress-bar progress-bar-success active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </td>
              </tr>
              <tr class = "row">
                ...
                <td  class = "col-xs-0 col-md-11 col-lg-11 col-sm-11">
                  <div class = "row">
                    <div class = "container-fluid col-xs-12 col-md-12 col-sm-12 col-lg-12 ">
                      <div id = "charityprog" class="progress-bar progress-bar-warning active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </td>
              </tr>
              <tr class = "row">
                ...
                <td  class = "col-xs-0 col-md-11 col-lg-11 col-sm-11">
                  <div class = "row">
                    <div class = "container-fluid col-xs-12 col-md-12 col-sm-12 col-lg-12 ">
                      <div id = "socialprog" class="progress-bar progress-bar-primary active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </td>
              </tr>
        ...
        <table class = "table shinetable" id = "table">
          ...
          <tr class = "row">
            ...
            <td  class = "col-xs-11 col-md-11 col-lg-0 col-sm-11">
              <div id = "hshine" class="progress-bar progress-bar-danger active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
            </td>
          </tr>
          <tr class = "row">
            <th class = "col-xs-1 col-md-1 col-lg-0 col-sm-1"><span class = "label shinelabel label-success">{{eshine}}</span></th>
            <td  class = "col-xs-11 col-md-11 col-lg-0 col-sm-11">
              <div id = "eshine" class="progress-bar progress-bar-success active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
            </td>
          </tr>
          <tr class = "row">
            <th class = "col-xs-1 col-md-1 col-lg-0 col-sm-1"><span class = "label shinelabel label-warning">{{cshine}}</span></th>
            <td  class = "col-xs-11 col-md-11 col-lg-0 col-sm-11">
              <div id = "cshine" class="progress-bar progress-bar-warning active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
            </td>
          </tr>
          <tr class = "row">
            <th class = "col-xs-1 col-md-1 col-lg-0 col-sm-1"><span class = "label shinelabel label-primary">{{sshine}}</span></th>
            <td class = "col-xs-11 col-md-11 col-lg-0 col-sm-11">
              <div id = "sshine" class="progress-bar progress-bar-primary active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
            </td>
          </tr>
        </table>
      </div>
